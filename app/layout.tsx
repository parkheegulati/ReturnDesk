...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={inter.className}>
      <body className="bg-frido-cream text-frido-ink min-h-screen flex flex-col antialiased selection:bg-purple-100 selection:text-purple-900">
        <Navbar />
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          {children}
        </main>
        <footer className="border-t border-frido-line py-6 text-center text-xs text-zinc-500 bg-[#FAF9F6]">
